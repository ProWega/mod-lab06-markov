...
TEST(TextGenTest, PrefixGeneration) {
    ...
    ASSERT_EQ(statetab[prefix({"слово1", "слово2"})], std::vector<std::string>({"слово3"}));
    ASSERT_EQ(statetab[prefix({"слово2", "слово3"})], std::vector<std::string>({"слово4"}));
    ASSERT_EQ(statetab[prefix({"слово3", "слово4"})], std::vector<std::string>({"слово5"}));
    ...
    ASSERT_EQ(statetab[prefix({"слово1", "слово2", "слово3"})], std::vector<std::string>({"слово4"}));
    ASSERT_EQ(statetab[prefix({"слово2", "слово3", "слово4"})], std::vector<std::string>({"слово5"}));
}
