...
// Константы для количества слов в префиксе и максимального количества генерируемых слов
const int NPREF = 2;
...
// Функция для генерации текста заданной длины на основе таблицы префиксов и суффиксов
